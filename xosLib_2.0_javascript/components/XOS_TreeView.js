function XOS_TreeView(  _htmlElement  )
{
...
XOS_TreeView.prototype.onMouseDown = function ( _e )
{
...
XOS_TreeView.prototype.isDoubleClick = function (  )
{
...
XOS_TreeView.prototype.onDoubleClickOnNodeName = function ( _element_div )
{
	this.editNodeName(_element_div);	
}

// in firefox  necessario disbilitare il drag dei nodi per poter selezionare il testo di input
XOS_TreeView.prototype.disableDraggableNodes = function ( )
{
...
XOS_TreeView.prototype.enableDraggableNodes = function ( )
{
...
XOS_TreeView.prototype.editNodeName = function ( _element_div )
{
...
XOS_TreeView.prototype.onEndEditNodeName = function ( _element_input )
{
	this.enableDraggableNodes();
	//must be redefined	and called super
}

XOS_TreeView.prototype.showNodeContextMenu = function ( _e )
{
	//must be redefined	
}
...
/*
XOS_TreeView.prototype.expandOrCollapseNode = function( _element_li  )
{
...
XOS_TreeView.prototype.expandNode = function(_element_li)
{
	/*
...
XOS_TreeView.prototype.collapseNode = function(_element_li)
{
...
XOS_TreeView.prototype.loadNodeChildren = function ( _url , _element_ul )
{
	//must be redefined
}


XOS_TreeView.prototype.getNodeElement_ul = function (  _element_li )
{		
...
XOS_TreeView.prototype.selectNode = function(_element_li)
{
...
XOS_TreeView.prototype.deselectNode = function(_element_li)
{
...
XOS_TreeView.prototype.deselectAllNodes = function()
{
...
/*
XOS_TreeView.prototype.createNodeHTML = function ( _iconType , _textLabel, _title , _hasChildren )
{
...
XOS_TreeView.prototype.createTreeViewNode = function (  _iconType , _textLabel, _title , _hasChildren )
{
