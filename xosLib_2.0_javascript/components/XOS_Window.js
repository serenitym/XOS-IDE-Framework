...
function XOS_Window(  _htmlElement  )
{	
...
XOS_Window.prototype.close = function ()
{
...
XOS_Window.prototype.isOpen = function ()
{
...
XOS_Window.prototype.bringToFront = function ()
{
...
XOS_Window.prototype.onMouseDown = function ( _e )
{
	this.bringToFront();
...
/*
XOS_Window.prototype.onTouchStart = function ( _e )
{
	this.onMouseDown( _e);	
}
*/
...
// chiamato da 	GLOBAL_MOUSE_LISTENER

XOS_Window.prototype.onGlobalMouseStartDrag = function ( )
{	
}
// chiamato da 	GLOBAL_MOUSE_LISTENER 

XOS_Window.prototype.onGlobalMouseEndDrag = function ( )
{		 
...
// chiamato da 	GLOBAL_MOUSE_LISTENER
 XOS_Window.prototype.onGlobalMouseDrag = function ( _e )
 {
